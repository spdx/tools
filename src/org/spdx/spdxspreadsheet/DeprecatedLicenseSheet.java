...
public class DeprecatedLicenseSheet extends AbstractSheet {
	 ...
	 */
	public void add(SPDXStandardLicense license, String deprecatedVersion) {
		Row row = addRow();
		...
		LicenseSheet.setTemplateText(templateCell, license.getTemplate(), license.getId(), workbookPath);
